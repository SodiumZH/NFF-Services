package net.sodiumzh.nautils.block;
...
public class BlockMaterial
{
	...
	/**
	 * Get properties from the material.
	 * @param colorOverride Custom map color.
	 */
	public BlockBehaviour.Properties properties(MapColor colorOverride)
	{
	...
	/**
	 * Get properties from the material using default map color.
	 */
	...
	/**
	 * Internal builder of block materials.
	 */
	protected static class Builder
	{
		...
		protected Builder mapColor(MapColor value)
		{
			mapColor = value;
			return this;
		}
		
		protected Builder noteBlockInstrument(NoteBlockInstrument value)
		{
			noteBlockInstrument = value;
			return this;
		}
		
		protected Builder pushReaction(PushReaction value)
		{
			pushReaction = value;
			return this;
		}
