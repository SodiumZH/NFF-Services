...
public interface IVanillaTradeListingCollection<T extends IVanillaTradeListing>
{
	...
	{
		return NaUtilsContainerStatics.getWeightedRandomSubset(allLevelsAndListings().get(merchantLevel).stream()
	...
	{
		Map<Integer, Integer> in = NaUtilsContainerStatics.toIndexMapInt(amountForEachLevel)
