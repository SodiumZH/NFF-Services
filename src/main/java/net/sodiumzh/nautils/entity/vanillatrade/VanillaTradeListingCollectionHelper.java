 ...
 * <p>It's recommended to use this helper only in the lambda supplier of {@link NaUtilsRegistries#VANILLA_TRADE_LISTING_COLLECTIONS}
 * entries.
 */
                ...
                try {
                    ...
                    switch (action)
                    {
                        ...
                        case "link": case "attach": {
                            ...
                            try {
                                this.attach((VanillaTradeListingCollection<VanillaTradeListing>) NaUtilsRegistries
