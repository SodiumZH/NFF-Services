 ...
 */
public class EntityLoadFailedEvent extends NaUtilsEntityEvent<Entity> {
    ...
    public void ignore(boolean shouldPrintStackTrace) {
        ...
        NaUtilsDebugStatics.errorOnce(EntityLoadFailedEvent.class, "NaUtils: Entity %s loading failed. Ignored.");
