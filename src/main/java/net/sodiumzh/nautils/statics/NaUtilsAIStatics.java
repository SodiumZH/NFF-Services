...
public class NaUtilsAIStatics
{
	...
	{
		return NaUtilsReflectionStatics.forceGet(goal, NearestAttackableTargetGoal.class, "f_26048_").cast();
	}
	
	public static TargetingConditions getTargetConditions(NearestAttackableTargetGoal<?> goal)
	{
		return NaUtilsReflectionStatics.forceGet(goal, NearestAttackableTargetGoal.class, "f_26051_").cast();
	}
	 ...
	 * <p> Note: this is for {@code goalSelector}. For {@code targetSelector}, use {@link NaUtilsAIStatics#insertTargetGoal}.
	 ...
	 * <p> Note: this is for {@code targetSelector}. For {@code goalSelector}, use {@link NaUtilsAIStatics#insertGoal}.
	 * <p> Note: this method is more costly than {@link GoalSelector#addGoal}. 
