...
public class NFFTagRegistry
{
	...
	public static final TagKey<EntityType<?>> NEUTRAL_TO_NFF_MOBS =
		NaUtilsTagStatics.createEntityTypeTag(NFFServices.MOD_ID, "neutral_to_nff_mobs");
	...
	public static final TagKey<EntityType<?>> PASSIVE_TO_NFF_MOBS =
		NaUtilsTagStatics.createEntityTypeTag(NFFServices.MOD_ID, "passive_to_nff_mobs");
	...
	public static final TagKey<EntityType<?>> IGNORES_GOLEM_ATTITUDE =
		NaUtilsTagStatics.createEntityTypeTag(NFFServices.MOD_ID, "ignores_golem_attitude");
	...
	public static final TagKey<EntityType<?>> COULD_BE_FROM_PIG =
		NaUtilsTagStatics.createEntityTypeTag(NFFServices.MOD_ID, "could_be_from_pig");
}
