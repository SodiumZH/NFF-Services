...
public class NFFRandomStrollGoal extends NFFMoveGoal {
	...
	public NFFRandomStrollGoal(INFFTamed pMob, double pSpeedModifier) {
	      this(pMob, pSpeedModifier, 120);
	   }

	public NFFRandomStrollGoal(INFFTamed pMob, double pSpeedModifier, int pInterval) {
	      this(pMob, pSpeedModifier, pInterval, true);
	   }

	public NFFRandomStrollGoal(INFFTamed pMob, double pSpeedModifier, int pInterval, boolean pCheckNoActionTime) {
	...
	public void onStart() {
		super.onStart();
		BlockPos wanted = NaUtilsMathStatics.getBlockPos(wantedX, wantedY, wantedZ);
