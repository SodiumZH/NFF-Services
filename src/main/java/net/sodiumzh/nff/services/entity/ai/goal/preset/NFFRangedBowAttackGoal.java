...
public class NFFRangedBowAttackGoal extends NFFGoal
{
	...
	public NFFRangedBowAttackGoal(INFFTamed pMob, double pSpeedModifier, int pAttackIntervalMin,
			float pAttackRadius)
	{
		super(pMob);
		if (!(pMob instanceof RangedAttackMob))
			throw new UnsupportedOperationException(
					"NFFRangedBowAttackGoal can appliy only on mobs implementing RangedAttackMob.");
