 ...
 * For vanilla {@link RangedAttackMob} support, use {@link NFFRangedAttackGoal}.
 */
public abstract class NFFShootProjectileGoal extends NFFGoal {
	@Nullable
	...
	public NFFShootProjectileGoal(INFFTamed mob, double pSpeedModifier, int pAttackInterval,
			float pAttackRadius) {
		this(mob, pSpeedModifier, pAttackInterval, pAttackInterval, pAttackRadius);
	}

	public NFFShootProjectileGoal(INFFTamed mob, double pSpeedModifier, int pAttackIntervalMin,
	...
	public <T extends NFFShootProjectileGoal> T setAttackIntervalGetter(Supplier<Integer> getter)
	{
	...
	@SuppressWarnings("unchecked")
	public <T extends NFFShootProjectileGoal> T setAttackIntervalMinGetter(Supplier<Integer> getter)
	{
	...
	@SuppressWarnings("unchecked")
	public <T extends NFFShootProjectileGoal> T setAttackIntervalMaxGetter(Supplier<Integer> getter)
	{
