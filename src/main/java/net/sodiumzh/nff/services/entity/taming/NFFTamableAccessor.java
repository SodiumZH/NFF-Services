...
/**
 * A utility for quick access of NFF tamable-related methods.
 */
public class NFFTamableAccessor {

    private Mob mob;

    public NFFTamableAccessor(Mob mob) {
        this.mob = mob;
    }

    public static NFFTamableAccessor of(Mob mob) {
        return new NFFTamableAccessor(mob);
    }
    ...
    public EntityDataComponent<Entity> getDataComponent() {
        return EntityComponentAPI.getComponentByPath(this.mob, "/nff/tamable/data", EntityComponentTypes.DATA.get())
                .orElseGet(() -> EntityComponentTypes.DATA.get().create(this.getMob()));
    }
