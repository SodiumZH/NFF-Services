...
public abstract class NFFMoveToBlockGoal extends NFFMoveGoal
{
	...
	public NFFMoveToBlockGoal(INFFTamed pMob, double pSpeedModifier, int pSearchRange)
	{
			...
			int pVerticalSearchRange)
	{
		...
		if (!(pMob instanceof PathfinderMob))
			throw new UnsupportedOperationException("NFFMoveToBlockGoal supports only PathfinderMob.");
