...
public class NFFMeleeAttackGoal extends NFFGoal
{
	...
	public NFFMeleeAttackGoal(INFFTamed pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen)
	{
		super(pMob);
		if (!(pMob instanceof PathfinderMob))
			throw new UnsupportedOperationException("NFFMeleeAttackGoal supports only PathfinderMob.");
	 ...
	 * Set -1 to disable.
	 */
	public NFFMeleeAttackGoal maxTicksNoAttack(int value)
	{
