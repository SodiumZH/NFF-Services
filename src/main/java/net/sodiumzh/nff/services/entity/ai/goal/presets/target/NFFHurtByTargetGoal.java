...
public class NFFHurtByTargetGoal extends NFFTargetGoal {
	...
	public NFFHurtByTargetGoal(INFFTamed mob, Class<?>... pToIgnoreDamage) {
		super(mob, true);
	...
	public NFFHurtByTargetGoal setAlertOthers(Class<?>... pReinforcementTypes) {
