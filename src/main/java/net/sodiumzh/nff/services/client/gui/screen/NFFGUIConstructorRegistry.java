...
public class NFFGUIConstructorRegistry
{
	 ...
	 */
	public static void register(Class<? extends NFFTamedInventoryMenu> menuClass, Function<NFFTamedInventoryMenu, NFFTamedGUI> makingMethod)
	{
	 ...
	 */
	public static  NFFTamedGUI make(NFFTamedInventoryMenu menu)
	{
